                ...
                <table className="table-transactions table">
                    <thead>
                        <tr>
                            ...
                            <th className="th-table-transaction">Titolo</th>
                            <th className="th-table-transaction">Tipo</th>
                            <th className="th-table-transaction">Data</th>
                            <th className="th-table-transaction">Importo</th>
                        </tr>
                    </thead>
                            ...
                            filteredTransactions.map((f) => (
                                <tr key={f.id}>
                                    ...
                                    <td className="d-flex gap-2">
                                        <button className="btn-table-transactions-update btn btn-primary btn-sm" onClick={() => {
